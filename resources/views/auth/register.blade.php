...
<html lang="en">
  <head>
    ...
    <title>COEG NI BOUS SENGGOL DONG</title>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content rounded-5 shadow">
      <div class="modal-header p-5 pb-4 border-bottom-0">
        ...
        <h2 class="fw-bold mb-0 mt-2">Daftar</h2>
      ...
      <div class="modal-body p-5 pt-0">
        ...
        <small class="text-muted">Isi menggunakan data yang benar!</small>
          ...
          <button class="w-100 mb-2 btn btn-lg rounded-4 btn-primary" type="submit">{{ __('Register') }}</button>
          <small class="text-muted">Sudah Memiliki Akun? <a href="{{ route('login') }}"">Login</a></small>
          <hr class="my-4">
          <h2 class="fs-5 fw-bold mb-3">Daftar dengan:</h2>
